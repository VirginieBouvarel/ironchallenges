...
describe('the JavaScript language', () => {
  describe('has different types and operators', () => {
    ...
    it('concatenate arrays - well, kind of', () => {
      ...
      expect(a + b).toEqual('1,2,34,5,6');//La concaténation crée une string en respectant l'asbence d'espaces
    });
    ...
    it('joins arrays and other things', () => {
      ...
      expect(1 + a).toEqual('11,2,3'); //Ca marche aussi avec les autres types -> conversion en string sans espace intermédiaire
      expect(a + 1).toEqual('1,2,31');
    ...
    it("can't compare arrays", () => {
      const a = [1, 2, 3];
      const b = [1, 2, 3];
      expect(a == a).toBeTruthy(); //c'est le même objet
      expect(a === a).toBeTruthy();
      expect(a == b).toBeFalsy();  //c'est le même contenu mais pas le même objet
